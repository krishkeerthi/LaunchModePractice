...
import com.example.singleinstancepertask.databinding.ActivityCBinding
...
class ActivityC : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.activityctobButton.setOnClickListener {
    ...
    override fun onRestart() {
        super.onRestart()
        Log.d(ContentValues.TAG, "onRestart: activity C")
    }
